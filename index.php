...
<link rel='icon' href='https://fonts.googleapis.com/css?family=Roboto'>
...
<div class="w3-content w3-margin-top" style="max-width:1400px;">
  ...
  <div class="w3-row-padding">
    ...
    <div class="w3-twothird">
	  ...
	  <hr>	  
	  <div class="w3-container w3-card w3-white" style="margin-left:0px;margin-right:0px" >
        <h2 class="w3-text-grey w3-padding-16" style="margin-left:0px;margin-right:0px" ><img src="images/hobbies.png" width="100PX" height="50px" style="margin-left:0px;margin-right:0px">Hobbies</h2>
       
        <div class="w3-container">
          <h5 class="w3-opacity"><b>Playing Cricket </b></h5>
		 
		  <h5 class="w3-opacity"><b>Playing Shuttle </b></h5>
		  <h5 class="w3-opacity"><b>Listing &amp Singing  songs</b></h5>
		  <h5 class="w3-opacity"><b>Cooking</b></h5>
